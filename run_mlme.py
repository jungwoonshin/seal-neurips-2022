"""
Train the Masked Label Model as Energy (MLME) on bibtex for 40 epochs.

Runs allennlp train with the mlme global_score and logs epoch-level
results to output/mlme_run/epoch_results.txt.
"""
...
SERIALIZATION_DIR = os.path.join("output", "mlme_run")
...
def write_config():
    ...
    config_path = os.path.join(SERIALIZATION_DIR, "mlme_config.json")
...
def collect_epoch_results():
    ...
    with open(output_path, "w", encoding="utf-8") as out:
        out.write("=" * 100 + "\n")
        out.write("MLME (Masked Label Model as Energy) -- Bibtex Training Results (40 epochs)\n")
        out.write("=" * 100 + "\n\n")
